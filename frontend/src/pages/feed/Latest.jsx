...
export default function FeedLatest() {
  ...
  const fetchFeed = useCallback(
    async (cursor = null) => {
      try {
        const response = await feedService.latestFeed(cursor, pageSize);
      ...
      <div className="mx-auto max-w-2xl px-4 py-8">
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">Follow some users or check back later</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4 px-4 py-8">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight">Latest Feed</h1>
